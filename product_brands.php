...
<!-- <section class="grid padding">
      ...
      <div class="col-md-3 col-sm-6">
        <div class="product_wrap heading_space">
          <div class="image">
            ...
            <a class="fancybox" href="images/product1.jpg"><img src="images/product5.jpg" alt="Product" class="img-responsive"></a>
          </div>
          <div class="product_desc">
           <p class="title">Sacrificial Chair Design </p>
           <div class="list_content">
  ...
  <section id="feature_product" class="bottom_half">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <h4 class="heading uppercase bottom30">Products</h4>
        </div>
        <div class="col-md-3 col-sm-6">
